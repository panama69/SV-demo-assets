...
start "ClaimProcessingService using http://localhost:7200/[MemberAccounts;Approval;ExchangeRate] virtual services" Application\bin\Debug\ClaimProcessingService.exe http://localhost:7200/MemberAccounts http://localhost:7200/Approval http://localhost:7200/ExchangeRate
goto :continue
:tibco
