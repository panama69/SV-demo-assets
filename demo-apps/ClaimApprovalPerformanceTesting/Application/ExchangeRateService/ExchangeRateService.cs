...
namespace HP.SOAQ.ServiceSimulation.Demo {
    ...
    public class ApprovalService {
        ...
        const string SERVICE_NAME = "ExchangeRateService";
        ...
        static void Main(string[] args) {
            ...
            Uri baseAddress = new Uri("http://localhost:8104/ServiceSimulation/Demo/" + SERVICE_NAME);
            ServiceHost selfHost = new ServiceHost(typeof(ExchangeRate), baseAddress);
            ...
            try {
                ...
                selfHost.AddServiceEndpoint(typeof(IExchangeRate), binding, SERVICE_NAME);
